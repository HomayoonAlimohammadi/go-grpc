...
var file_proto_laptop_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0xd2, 0x03, 0x0a, 0x06, 0x4c, 0x61, 0x70, 0x74, 0x6f,
	...
	0x53, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x52, 0x06, 0x73, 0x63, 0x72, 0x65, 0x65, 0x6e, 0x12, 0x28,
	0x0a, 0x08, 0x6b, 0x65, 0x79, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b,
	...
	0x74, 0x42, 0x08, 0x0a, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x32, 0x54, 0x0a, 0x0d, 0x4c,
...
var file_proto_laptop_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_laptop_proto_goTypes = []interface{}{
	...
	(*Screen)(nil),               // 7: pb.Screen
	(*Keyboard)(nil),             // 8: pb.Keyboard
	(*timestamp.Timestamp)(nil),  // 9: google.protobuf.Timestamp
}
var file_proto_laptop_proto_depIdxs = []int32{
	2, // 0: pb.CreateLaptopRequest.laptop:type_name -> pb.Laptop
	3, // 1: pb.Laptop.cpu:type_name -> pb.CPU
	4, // 2: pb.Laptop.ram:type_name -> pb.Memory
	5, // 3: pb.Laptop.gpus:type_name -> pb.GPU
	6, // 4: pb.Laptop.storages:type_name -> pb.Storage
	7, // 5: pb.Laptop.screen:type_name -> pb.Screen
	8, // 6: pb.Laptop.keyboard:type_name -> pb.Keyboard
	9, // 7: pb.Laptop.updated_at:type_name -> google.protobuf.Timestamp
	0, // 8: pb.LaptopService.CreateLaptop:input_type -> pb.CreateLaptopRequest
	1, // 9: pb.LaptopService.CreateLaptop:output_type -> pb.CreateLaptopResponse
...
func file_proto_laptop_proto_init() {
	...
	file_proto_laptop_proto_msgTypes[2].OneofWrappers = []interface{}{
		(*Laptop_WeightKg)(nil),
		(*Laptop_WeightLb)(nil),
	}
	type x struct{}
